...
#ifndef FIRMWARE_ICM_20948_H
#define FIRMWARE_ICM_20948_H

#include <mbed.h>

#define ICM_20948_AD0_HIGH 0x69
#define ICM_20948_AD0_LOW 0x68
...
private:
    ...
    void _switchBank(Bank bank);
public:
    ICM_20948(PinName sda, PinName scl, uint8_t address = ICM_20948_AD0_LOW);

    void readAccel(Vector* payload);
    void readGyro(Vector* payload);

};


#endif //FIRMWARE_ICM_20948_H
